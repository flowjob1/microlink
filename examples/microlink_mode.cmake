...
if(MICROLINK_MODE STREQUAL "uart")
    set(EXTRA_COMPONENT_DIRS "${_MICROLINK_REPO_ROOT}/components/microlink-mode-uart")
elseif(MICROLINK_MODE STREQUAL "usb")
    set(EXTRA_COMPONENT_DIRS "${_MICROLINK_REPO_ROOT}/components/microlink-mode-usb")
else()
